System.register(['aurelia-templating', 'aurelia-binding', 'aurelia-logging'], (function (exports) {
    'use strict';
    var BehaviorInstruction, BindingLanguage, camelCase, SVGAnalyzer, bindingMode, enqueueBindingConnect, connectable, sourceContext, BindingExpression, ListenerExpression, delegationStrategy, CallExpression, Parser, ObserverLocator, EventManager, NameExpression, LiteralString, LogManager;
    return {
        setters: [function (module) {
            BehaviorInstruction = module.BehaviorInstruction;
            BindingLanguage = module.BindingLanguage;
        }, function (module) {
            camelCase = module.camelCase;
            SVGAnalyzer = module.SVGAnalyzer;
            bindingMode = module.bindingMode;
            enqueueBindingConnect = module.enqueueBindingConnect;
            connectable = module.connectable;
            sourceContext = module.sourceContext;
            BindingExpression = module.BindingExpression;
            ListenerExpression = module.ListenerExpression;
            delegationStrategy = module.delegationStrategy;
            CallExpression = module.CallExpression;
            Parser = module.Parser;
            ObserverLocator = module.ObserverLocator;
            EventManager = module.EventManager;
            NameExpression = module.NameExpression;
        ...
        execute: (function () {
            ...
            ***************************************************************************** */
            ...
            var ChildInterpolationBinding = exports('ChildInterpolationBinding', (function () {
            ...
            var LetBinding = exports('LetBinding', (function () {
            ...
            var info = {};
            var TemplatingBindingLanguage = exports('TemplatingBindingLanguage', (function (_super) {
