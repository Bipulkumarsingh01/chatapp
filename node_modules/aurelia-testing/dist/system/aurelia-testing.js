System.register(['aurelia-templating', 'aurelia-logging', 'aurelia-pal'], (function (exports) {
    'use strict';
    var TargetInstruction, View, getLogger, DOM;
    return {
        ...
        execute: (function () {
            ...
            exports({
                configure: configure,
                waitFor: waitFor,
                waitForDocumentElement: waitForDocumentElement,
                waitForDocumentElements: waitForDocumentElements
            });

            var CompileSpy = exports('CompileSpy', (function () {
            ...
            var ViewSpy = exports('ViewSpy', (function () {
                function ViewSpy() {
